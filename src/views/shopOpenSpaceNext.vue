	              ...
	              <p>选择开通时长</p>
	               <div class="list-block">
				      <ul>
				        ...
				        <li class="item-content">
				          <div class="item-inner">
				            <div class="item-title">空间大小</div>
				            <div class="item-after">{{param.spaceSize}}</div>
				          </div>
				        </li>
				        <li class="item-content">
				          <div class="item-inner">
				    ...
				    <div class="list-block payMethod">
					  ...
					  <p @click="paySpaceNext"><a href="javascript:;" class="button button-fill">确认支付</a></p>
	...
	export default {
		...
		created (){
			...
			for(let item of url){
				...
				if(item.indexOf("spaceSize")>-1){
					this.param.spaceSize=item.split("=")[1];
				}
